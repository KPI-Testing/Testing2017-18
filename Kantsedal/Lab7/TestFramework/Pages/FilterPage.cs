...
namespace TestFramework.Pages
{
    public class FilterPage : BasePage
    {
        ...
        //[FindsBy(How = How.XPath, Using = "//span[@class='sprite-side btn-link g-buy-submit-light']/button[@type='submit']")]
        ...
        public IList<IWebElement> CheckboxSet;
        public IList<Checkbox> Publishing
        {
            get
            {
                return CheckboxSet.Select(iwebe =>new Checkbox(iwebe)).ToList();
            }
        }
