package Custom_elements.customdecorator;
        ...
        import Custom_elements.Element;
...
public class CustomFieldDecorator extends DefaultFieldDecorator {
    ...
    public CustomFieldDecorator(SearchContext search_cont) {
        super(new DefaultElementLocatorFactory(search_cont));
    }
