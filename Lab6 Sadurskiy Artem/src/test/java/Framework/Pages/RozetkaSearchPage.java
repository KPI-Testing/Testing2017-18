...
public class RozetkaSearchPage {
    ...
    public RozetkaSearchPage(ChromeDriverEx driver){
        this.driver = driver;
    ...
    public RozetkaSearchPage setMinimumPrice(Integer price){
        if(price == null) return this;
        MinPrice.sendKeys(price.toString());
        return this;
    }

    public RozetkaSearchPage setMaximumPrice(Integer price){
        if(price == null) return this;
    ...
    public RozetkaSearchPage PriceSumit(){
